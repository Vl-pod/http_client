...
btnSendAddForm.addEventListener('click', (e) => {
  ...
  postData('https://http-server-ubns.onrender.com/api/ticket/create', data).then((response) => {
    const task = new Task();
...
list.addEventListener('click', async (e) => {
  ...
  if (e.target.classList.contains('btn-edit')) {
    ...
    btnSendEditForm.addEventListener('click', (e) => {
      ...
      postData(`https://http-server-ubns.onrender.com/api/ticket/edit/${taskId}`, data).then((response) => {
        if (response) {
